...
/*
 * tpm_log_quote_statement
 * -----------------------
 * Decode and render the TcgAttestQuote fields generated by tpm_quote_pcrs().
 * This is diagnostic-only: it performs no TPM operation and does not alter the
 * evidence bytes.  The caller decides whether logging is enabled.
 */
